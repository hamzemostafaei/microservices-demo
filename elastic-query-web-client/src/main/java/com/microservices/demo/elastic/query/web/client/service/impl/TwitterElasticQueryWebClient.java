...
@Slf4j
@Service
public class TwitterElasticQueryWebClient implements IElasticQueryWebClient {
    ...
    private WebClient.ResponseSpec getWebClient(ElasticQueryWebClientRequestModel requestModel) {
        return webClientBuilder
                .build()
                .method(HttpMethod.valueOf(elasticQueryWebClientConfigData.queryByText().method()))
                .uri(elasticQueryWebClientConfigData.queryByText().uri())
