...
public class TwitterElasticIndexClientService implements IElasticIndexClientService<TwitterIndexModel> {
    ...
    public List<String> save(List<TwitterIndexModel> documents) {
        ...
        List<IndexedObjectInformation> indexedDocuments = elasticsearchOperations.bulkIndex(
                indexQueries,
                IndexCoordinates.of(elasticConfigData.indexName())
        );

        List<String> documentIds = indexedDocuments.stream()
