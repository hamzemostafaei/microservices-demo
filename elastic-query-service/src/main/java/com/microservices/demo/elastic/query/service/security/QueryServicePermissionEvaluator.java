...
public class QueryServicePermissionEvaluator implements PermissionEvaluator {
    ...
    public boolean hasPermission(Authentication authentication,
        ...
        if (targetDomain instanceof ElasticQueryServiceRequestModel esRequestModel) {
            return preAuthorize(authentication, esRequestModel.getId(), permission);
    ...
    private boolean preAuthorize(Authentication authentication, String id, Object permission) {
        ...
        PermissionTypeEnum userPermission = twitterQueryUser.getPermissions().get(id);
    ...
    private boolean postAuthorize(Authentication authentication,
        ...
        for (ElasticQueryServiceResponseModel responseModel : responseBody) {
            PermissionTypeEnum userPermission = twitterQueryUser.getPermissions().get(responseModel.getId());
    ...
    private boolean hasPermission(String requiredPermission, PermissionTypeEnum userPermission) {
